...
var BaseStorage = /** @class */ (function (_super) {
     ...
     */
    BaseStorage.init = function (executor) {
        // @ts-ignore
    ...
    BaseStorage.prototype.getObjectStore = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.dataBaseExecutor.getObjectStorage(_this.model.name, resolve, reject);
        });
    };
    /**
    ...
    BaseStorage.prototype.setItem = function (item, key) {
        ...
        if (key) {
            this.dataBaseExecutor.setByKey(this.model.name, item, key, function (key) {
                _this.onWrite({ key: key, value: item });
            }, function () {
            });
        }
        else
    ...
    BaseStorage.prototype.setItems = function (items) {
        var _this = this;
        this.dataBaseExecutor.setList(this.model.name, items, function (keys) {
            // @ts-ignore
            _this.onWrite({ key: keys, value: items });
        }, function () {
        });
    };
    /**
    ...
    BaseStorage.prototype.partialUpdate = function (key, chunk) {
        var _this = this;
        this.getItem(key).then(function (item) {
            if (item)
    ...
    BaseStorage.prototype.removeItemsByQuery = function (query, index) {
        ...
        this.dataBaseExecutor.removeWithQuery(this.model.name, query, index, function (keys) {
            _this.onDelete({ key: Array.from(keys) });
        }, function () {
        });
    };
    /**
